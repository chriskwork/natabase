<nav class="bg-white mx-auto border-gray-200 border-b max-w-6xl">
  <div class="flex justify-between items-center mx-auto px-4 py-4 w-full">
    ...
    <!-- mobile menu -->
    <button id="menu-toggle" class="lg:hidden flex flex-col gap-1.5 p-2">
  ...
  <div id="mobile-menu" class="hidden lg:hidden px-4 pb-4">
    ...
    <div class="flex flex-col gap-3">
      ...
      <a href="#" class="bg-brand-turquoise hover:bg-[#0088b3] shadow-sm hover:shadow-md px-6 py-2 rounded-lg font-semibold text-white text-center transition-colors duration-200">
        Hazte socio
      </a>
    </div>
  </div>
